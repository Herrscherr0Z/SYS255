...
$scprule = read-host -Prompt "Would you like to transfer this file to the webserver?"

Switch ($scprule) {
    0 { 
    }

    1 { Set-SCPFile -ComputerName '10.0.5.4' -Credential $credential -RemotePath "/joshua/" -LocalFile 'C:\Users\joshua.leonmejia-adm\'
    }
